...
<div class="mx-auto col-lg-12">
    <div class="card">
        ...
        <form class="form-horizontal" action="{{ route('admin.users.store') }}" id="kt_form_1" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                ...
                <div class="form-group">
                    <label>Email:</label>
                    <input id="email-field" type="text" class="form-control" placeholder="Email" name="email" required>
                </div>
