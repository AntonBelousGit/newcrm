        ...
        <div class="flex-wrap container-fluid d-flex align-items-center justify-content-between flex-sm-nowrap">
            ...
            <div class="flex-wrap mr-1 d-flex align-items-center">
                ...
                <div class="flex-wrap mr-5 d-flex align-items-baseline">
                    <!--begin::Page Title-->
                    <h5 class="my-1 mr-5 text-dark font-weight-bold">{{ ('Tracker')}}</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    ...
                    <!--end::Breadcrumb-->
                    <a href="{{ route('admin.tracker.create') }}" class="btn btn-light-primary font-weight-bolder btn-sm"><i class="flaticon2-add-1"></i> {{ ('Add New Tracker')}}</a>
                </div>
                <!--end::Page Heading-->
            </div>
            <!--end::Info-->
                        ...
                        @can('manage-agent',$shipment)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('admin.tracker.show', $shipment->id)}}" title="Show">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                @canany(['SuperUser','Manager','OPS'], Auth::user())
                                    <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('admin.tracker.edit', $shipment->id)}}" title="{{  ('Edit') }}">
